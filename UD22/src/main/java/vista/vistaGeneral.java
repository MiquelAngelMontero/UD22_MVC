...
public class vistaGeneral  extends JFrame implements ActionListener{
private static final long serialVersionUID = 1L;
	
	private controlGeneral controlgen; //objeto PersonaController que permite la relacion entre esta clase y la clase PersonaController
	...
	/**
	public void setCoordinador(controlGeneral personaController) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==botonRegistrar) {
			//controlGeneral.mostrarVentanaRegistro();			
		}
		if (e.getSource()==botonBuscar) {
			//controlGeneral.mostrarVentanaConsulta();			
		}
	}
